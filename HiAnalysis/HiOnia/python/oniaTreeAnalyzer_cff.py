...
def oniaTreeAnalyzer(process, muonSelection="Trk", L1Stage=2, isMC=True, pdgID=443, outputFileName="OniaTree.root", muonlessPV = False, doTrimu=False, doDimuTrk=False, flipJpsiDir=0, miniAOD=True, miniAODcuts=False, OnlySingleMuons=False):
...
###################### Onia Skim Producer #################################################
    ...
    onia2MuMuPAT(process, GlobalTag=process.GlobalTag.globaltag, MC=isMC, Filter=False, useL1Stage2=(L1Stage==2), doTrimuons=doTrimu, DimuonTrk=doDimuTrk, flipJpsiDir=flipJpsiDir)
###
